...
mod tests {
    ...
    use crate::{authz::Authz, bank::Bank, Account, ProvwasmTestApp};
    use test_tube_prov::Module;
    ...
    fn authz_integration() {
        ...
        let signer = app
            .init_account(&[
                Coin::new(100_000_000_000_000_000_000u128, "nhash"),
                Coin::new(10u128, "usdc"),
            ])
            .unwrap();
        let receiver = app
            .init_account(&[Coin::new(1_000_000_000_000u128, "nhash")])
            .unwrap();
        ...
        GenericAuthorization::encode(
            &GenericAuthorization {
                msg: "/provenance.marker.v1.MsgTransferRequest".to_string(),
            },
            &mut buf_2,
        )
        .unwrap();
